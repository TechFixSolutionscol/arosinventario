...
(function () {
    ...
    async function login(username, password) {
        ...
        // URL del Web App (centralizada en config.js)
        ...
        try {
            ...
            if (data && data.status === 'success') {
                ...
                localStorage.setItem('inv_current_role', data.rol || 'Vendedor');
                return true;
            }
            ...
            localStorage.setItem('inv_current_user', username);
            localStorage.setItem('inv_current_role', entry.role || 'Vendedor');
            return true;
        }
    ...
    function logout() {
        ...
        localStorage.removeItem('inv_current_role');
    }
    ...
    function currentUserRole() {
        return localStorage.getItem('inv_current_role') || 'Vendedor';
    }

    // Exponer funciones globales mínimas
    window.InvAuth = { register, createUserInternal, login, logout, currentUser, currentUserRole, getUsers };
